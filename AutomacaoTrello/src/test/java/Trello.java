...
public class Trello {
    ...
    public void login() {
        ...
        //espera o campo username ficar visível
        Global.capabilitiesMethods.waitVisible(Global.driver, By.xpath(user));
    ...
    public void removerTag(String nomeLista, String nomeCartao) {
        ...
        Global.capabilitiesMethods.click(
                ...
                1000);
        // seleciona o menu tag
        Global.capabilitiesMethods.click(Global.driver, By.xpath(addTag), 1000);
    ...
    public void logout() {
        ...
        Global.capabilitiesMethods.click(Global.driver, By.xpath(btnLogout), 1000);
        ...
        if (quantidade > 0) {
            for (int i = quantidade; i >= 1; i--) {
                ...
                if (!Global.capabilitiesMethods.isVisible(Global.driver, By.xpath(elementoXPath))) {
                    ...
                    Global.capabilitiesMethods.click(Global.driver, By.xpath(elementoXPath), 2000);
                }
                // Exclui o quadro
